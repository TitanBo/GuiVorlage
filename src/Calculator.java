...
public class Calculator implements ActionListener
{
    ...
    Calculator()
    {
        ...
        for(i = 0; i < 12; ++i)
        {
            ...
            this.functionButtons[i].setFont(Gui.smallFont);
        ...
        for(i = 0; i < 10; ++i)
        {
            ...
            this.numberButtons[i].setFont(Gui.largeFont);
